...
Template JSON: /app/.desloppify/external_review_sessions/ext_20260514_233228_f17efe68/review_result.template.json
Output JSON path: /app/.desloppify/external_review_sessions/ext_20260514_233228_f17efe68/review_result.json
...
then read the actual source code.
  ...
  desloppify show smells --no-budget      # 1 findings
...
1. Keep `session.id` exactly `ext_20260514_233228_f17efe68`.
2. Keep `session.token` exactly `2556e14b71b02ee697277ecb4c17b909`.
